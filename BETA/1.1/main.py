...
class Main:
    ...
    DEFAULT_USER_DEFAULTS = {
        ...
        "default_missing_suffix": "_6_STUDIES_NOT_DOWNLOADED",
        ...
        while True:
            ...
            if key is not None:
                if key == '_T_ERROR_':
                    ...
                    tbl_results = self.apply_dual_selections(df_results, dual_selections, ALL_PREFIX).values.tolist()
                    ...
                    path_out = os.path.join(dir_out, fname_out)
                    self.save_to_xlsx(ui, path_out, df_ignored, file_descriptor='ANON-IGNORED ENTRIES')
                    ...
                    if sort_yes:
                        df_results = df_results.sort_values(by=sort_yes)
                    tbl_studies = self.apply_dual_selections(df_results, dual_selections, ALL_PREFIX).values.tolist()
            ...
            # DEPRECATED, NOT USED
                ...
                df_move = self.apply_dual_selections(df_move, dual_selections, ALL_PREFIX)
