...
class GUI:
    ...
    def createMainWindow(self,
        ...
        text_table_raw_main = sg.Text('    1. Studies of Interest (Queries)', text_color='darkblue', font='Any 11')
        txt_load_main = sg.Input('', visible=False, do_not_clear=False, enable_events=True, key='_TXT_LOAD_MAIN_')
        btn_load_main = sg.Button('LOAD',
                                  size=(7, 1),
        ...
        btn_find_main = sg.Button('SEARCH DATABASE',
                                  size=(20, 1),
                                  button_color=self.default_btn_color,
                                  key='_FIND_MAIN_')
        ...
        text_studyoffset_MAIN = sg.Text('Study Numbering:', key='_TEXT_STUDYOFFSET_MAIN_')
        input_studyoffset_MAIN = sg.Input('1', do_not_clear=True, size=(6, 1), font=None,
                                          enable_events=True, key='_STUDYOFFSET_MAIN_')
        """
        ...
        # ------ COMBO: Source Peer
        text_src_main = sg.Text('2. Source (Peer)', text_color='darkblue', font='Any 11')
        ...
        col_arrow_main = sg.Column([
            [self.spacer()],
            [sg.Text('-'*arrow_size + '>', font='Any 11')],  #, text_color='blue')]
        ], pad=(0, 0))

        # ------ COMBO: Destination Peer
        text_dest_main = sg.Text('5. Destination (Peer)', text_color='darkblue', font='Any 11')
        combo_dest_main = sg.Combo([], size=(21, 1), readonly=True, key='_COMBO_DEST_MAIN_')
        col_dest_main = sg.Column([
            [text_dest_main],
            [combo_dest_main],
            [checkbox_skip_MAIN],
            [text_studyoffset_MAIN, input_studyoffset_MAIN],
            [btn_move_main],
        ])

        # ------ C-MOVE STUDY/SERIES SELECTION
        text_dest_btns_main = sg.Text('3. Selection Filters', text_color='darkblue', font='Any 11')
        ...
        btn_value_selector = sg.Button('SELECT STUDIES/SERIES',
                                       size=(24, 1),
                                       button_color=self.default_btn_color,
                                       disabled=True,
                                       key='_FILT_MAIN_')
        ...
        # ------ C-MOVE ANONYMIZATION PARAMETERS
        text_anonparam_main = sg.Text('4. Anonymization Parameters', text_color='darkblue',
                                           font='Any 11')

        checkbox_anonymize_MAIN = sg.Checkbox('Anonymize', default=True, key='_ANONYMIZE_MAIN_')

        btn_anonparam = sg.Button('CUSTOMIZE ANONYMIZATION',
                                       size=(24, 1),
                                       button_color=self.default_btn_color,
                                       disabled=True,
                                       key='_ANONPARAM_MAIN_')



        col_anon_main = sg.Column([
            [text_anonparam_main],
            [checkbox_anonymize_MAIN],
            [btn_anonparam]
        ])
        ...
        col_middle_main = sg.Column([
            [col_arrow_main, col_selection_btn_main, col_arrow_main, col_anon_main, col_arrow_main],
            [frame_localdir_main]
        ])
