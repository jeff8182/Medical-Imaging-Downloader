...
class Main:
    ...
    DEFAULT_TAG_TO_EXCEL = {
        ...
        'StudyTime': ["Time", "Study Time", "Time of Study", "Begin Exam Datetime"],
    ...
    def parse_time(self, tm, format):
        ...
        potential_time_formats = ['%H:%M:%S.%f', '%H:%M:%S', '%H:%M', '%H%M%S.%f', '%H%M%S', '%H%M']
    ...
    def craft_queries(self, df, query_tags, master_tagname_to_tag, query_identifier_col='Query', args=None):
        queries = []
    ...
    def format_df_columns(self, df, master_tagname_to_tag, parse_func={}, parse_by_vr_func={}):
        ...
        return df
    def format_df(self, df, master_tagname_to_tag, parse_func={}, parse_by_vr_func={}):
        # --------- General formatting
        ...
        while True:
            ...
            if key is not None:
                if key == '_T_ERROR_':
                    ...
                    try:
                        df_results_temp = self.format_df(df_results_temp, master_tagname_to_tag,
                                                         self.parse_to_val_func,
                                                         self.parse_to_val_by_VR_func)
                    except Exception as err:
                        traceback.print_stack()
            ...
            if event == '':
                ...
                try:
                    df_queries_temp = self.format_df(df_queries_temp, master_tagname_to_tag,
                                                     self.parse_to_val_func,
                                                     self.parse_to_val_by_VR_func)
                except Exception as err:
                    traceback.print_stack()
                ...
                queries = self.craft_queries(df_queries, query_tags=query_tags_sorted,
            ...
            # DEPRECATED, NOT USED
                ...
                # assemble queries
                queries = self.craft_queries(df_move, query_tags=query_tags_sorted,
